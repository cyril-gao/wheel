...
public class Backtracking {
    ...
    private boolean selectNext(int[] candidates, int from, int target, Deque<Integer> temporary, Set<List<Integer>> solutions)
    {
        boolean retval = false;
        if (target > 0) {
    ...
    private boolean selectNext2(int[] candidates, int from, int target, Deque<Integer> temporary, Set<List<Integer>> solutions)
    {
        boolean retval = false;
        if (target > 0) {
            if (candidates[from] <= target) {
